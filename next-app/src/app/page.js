...
const NFT_CONTRACT_ADDRESS = "0xfc077853a100a1a409ed47b1bb30490666a6b59e";
...
export default function Home() {
  ...
  const mintToken = async () => {
    ...
    try {
      ...
      alert("NFT minting started! Transaction hash: " + hash);
      ...
      if (error.message.includes("insufficient funds")) {
        alert("Insufficient funds. Make sure you have enough ETH!");
      } else {
